    ...
    <div class="tw-flex tw-flex-col tw-bg-[#defcc2] tw-items-center tw-w-full">
       ...
       <div class="tw-bg-[#81cdfb] tw-my-10 tw-overflow-visible tw-w-[92.5%] tw-relative tw-justify-center  tw-flex tw-flex-col tw-p-5">
         ...
         <div :class="['tw-flex tw-w-full tw-overflow-hidden tw-items-center tw-transition-transform    tw-gap-7  tw-p-2', translateScale]">
           ...
           <div v-for="(crop, index) in eastCropsRecord" id="item" :class="['tw-bg-white  tw-transform  tw-p-1 tw-overflow-hidden tw-flex-shrink-0 tw-flex tw-justify-center tw-flex-col tw-items-center', translateScale ]">
           <img class="tw-w-48 tw-h-48 hover:tw-scale-105  tw-duration-500 tw-p-1 tw-cursor-pointer" :src="crop.image" alt="cropImage">
           <span class="tw-text-sm tw-font-semibold tw-text-[#3e7111]">{{ crop.crop }}</span>
           </div>
         </div>
       ...
       <div class="tw-bg-[#81cdfb] tw-my-10 tw-overflow-visible tw-w-[92.5%] tw-relative tw-justify-center  tw-flex tw-flex-col tw-p-5">
         ...
         <div :class="['tw-flex tw-w-full tw-overflow-hidden tw-items-center tw-transition-transform    tw-gap-7  tw-p-2', translateScale]">
           ...
           <div v-for="(crop, index) in northCropsRecord" id="item" :class="['tw-bg-white  tw-transform  tw-p-1 tw-overflow-hidden tw-flex-shrink-0 tw-flex tw-justify-center tw-flex-col tw-items-center', translateScale ]">
           <img class="tw-w-48 tw-h-48 hover:tw-scale-105  tw-duration-500 tw-p-1 tw-cursor-pointer" :src="crop.image" alt="cropImage">
           <span class="tw-text-sm tw-font-semibold tw-text-[#3e7111]">{{ crop.crop }}</span>
           </div>
         </div>
       ...
       <div class="tw-bg-[#81cdfb] tw-my-10 tw-overflow-visible tw-w-[92.5%] tw-relative tw-justify-center  tw-flex tw-flex-col tw-p-5">
         ...
         <div :class="['tw-flex tw-w-full tw-overflow-hidden tw-items-center tw-transition-transform    tw-gap-7  tw-p-2', translateScale]">
           ...
           <div v-for="(crop, index) in southCropsRecord" id="item" :class="['tw-bg-white  tw-transform  tw-p-1 tw-overflow-hidden tw-flex-shrink-0 tw-flex tw-justify-center tw-flex-col tw-items-center', translateScale ]">
           <img class="tw-w-48 tw-h-48 hover:tw-scale-105  tw-duration-500 tw-p-1 tw-cursor-pointer" :src="crop.image" alt="cropImage">
           <span class="tw-text-sm tw-font-semibold tw-text-[#3e7111]">{{ crop.crop }}</span>
           </div>
         </div>
